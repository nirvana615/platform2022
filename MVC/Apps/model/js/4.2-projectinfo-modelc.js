...
function ModelProjectInfo(id, style) {
    if (style == "view") {
        ...
        $("#model_reset_add").on("click", function () {
            DelEntitiesInViewer(newprojectentities);//点击重置删除标注
