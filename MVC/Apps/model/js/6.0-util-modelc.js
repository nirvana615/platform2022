...
util.fixbar({
    ...
    , bar3: '<li class="layui-icon" lay-type="bar3" id="utilbar3" style="margin:5px;border-radius:5px;background-color:#393D49">' + '<svg t="1640763581149" class="icon" style="position:relative;top:5px" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7172" width="42" height="42"><path d="M524.8 608c-160 0-288-128-288-288s128-288 288-288 288 128 288 288-128 288-288 288z m0-512c-121.6 0-224 102.4-224 224s102.4 224 224 224 224-102.4 224-224-102.4-224-224-224z" p-id="7173" fill="#ffffff"></path><path d="M140.8 992c-19.2 0-32-12.8-32-32 0-230.4 185.6-416 416-416 102.4 0 198.4 38.4 275.2 102.4 12.8 12.8 12.8 32 0 44.8-12.8 12.8-32 12.8-44.8 0-64-57.6-147.2-89.6-236.8-89.6-192 0-352 160-352 352 6.4 25.6-6.4 38.4-25.6 38.4z" p-id="7174" fill="#ffffff"></path><path d="M640 992L499.2 851.2c-12.8-12.8-12.8-32 0-44.8 12.8-12.8 32-12.8 44.8 0l96 96L934.4 608c12.8-12.8 32-12.8 44.8 0s12.8 32 0 44.8L640 992z" p-id="7175" fill="#ffffff"></path></svg></li>'
