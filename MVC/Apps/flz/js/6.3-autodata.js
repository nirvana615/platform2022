    ...
    if (currentprojectid == null) {
        ...
        if (automonitordatalayerindex == null) {
            automonitordatalayerindex = layer.open({
                ...
                , maxmin: true
                , moveOut: true
                , content: '<form class="layui-form" style="margin-top:5px;margin-right:5px;" lay-filter="queryJieliinfoform"><div class="layui-form-item"><div class="layui-row"><div class="layui-col-md4"><div class="grid-demo grid-demo-bg1"><label class="layui-form-label">模型</label><div class="layui-input-block"><select id="modleIdSelect" name="modleId"><option value="">请选择</option></select></div></div></div></div></div><div class="layui-form-item" style="margin-top:5px;hegiht:40px"><div style="position:absolute;right:15px;"><button type="reset" class="layui-btn layui-btn-primary" style="width:100px">重置</button><button type="submit" class="layui-btn" lay-submit="" lay-filter="querymeiJiegousubmit" style="width:100px">查询</button></div></div></form><div id="autodatachart" class="layui-tab-item layui-show" style="width:790px;height:540px;top:40px"></div>'
                , zIndex: layer.zIndex
                , success: function (layero) {
                    ...
                    form.on('submit(querymeiJiegousubmit)', function (data) {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                if (result == "") {
                                    //无监测剖面信息
                                    layer.msg("无结构信息！", { zIndex: layer.zIndex, success: function (layero) { layer.setTop(layero); } });
