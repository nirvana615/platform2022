...
var markAddPointLayerList=[];//新增点标注裂变
       ...
       , zIndex: layer.zIndex
        , success: function (layero) {
            ...
            layui.tree.render({
                ...
                , customOperate: false
                , showLine: true
                , data: markAddPointLayerList
                , edit: ['update', 'del']
                , accordion: true
                , click: function (obj) {
                    AddPointMarkLayerClick(obj);
                }
            });
        }
        , end: function () {
                ...
                if (height > 0) {
                    ...
                    if (Cesium.defined(position)) {
                        viewer.entities.add({
                            ...
                            position: position,
                            billboard: {
                                image: "../Resources/img/mark/mark_P1.png",
...
//是否模型标注
layui.form.on('switch(modelpoltswitch-type)', function (data) {
    modelpolt = data.elem.checked;
    if (viewer.scene.primitives.length < 2) {
        layer.msg('请先加载模型数据！');
        document.getElementById("modelpoltswitch_id").checked = false;
        modelpolt = false;
        layui.form.render();
    }
    return false;
...
function AddPointMarkLayerClick(obj) {
...
function selectMarkStyle(obj) {
    ...
    if (markType == "0" || markClickType=="point") {
        markstylelayerindex = layer.open({
            ...
            , moveOut: true
            , resize: false
            , content:'<form class="layui-form" style="margin-top:10px;margin-left:0px;" lay-filter="markpointinfoform">    <fieldset class="layui-elem-field" style="margin-left: 10px;margin-right: 10px;">        <div class="layui-field-box">            <img id="img_mark_P1" src="/Resources/img/mark/mark_P1.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P2" src="/Resources/img/mark/mark_P2.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P3" src="/Resources/img/mark/mark_P3.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P4" src="/Resources/img/mark/mark_P4.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P5" src="/Resources/img/mark/mark_P5.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P6" src="/Resources/img/mark/mark_P6.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P7" src="/Resources/img/mark/mark_P7.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P8" src="/Resources/img/mark/mark_P8.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P9" src="/Resources/img/mark/mark_P9.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P10" src="/Resources/img/mark/mark_P10.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P11" src="/Resources/img/mark/mark_P11.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P12" src="/Resources/img/mark/mark_P12.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P13" src="/Resources/img/mark/mark_P13.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P14" src="/Resources/img/mark/mark_P14.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P15" src="/Resources/img/mark/mark_P15.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P16" src="/Resources/img/mark/mark_P16.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">            <img id="img_mark_P17" src="/Resources/img/mark/mark_P17.png" style=" width: 30px; height: 30px;margin: 5px;" class="markPointStyle">        </div>    </fieldset>    <div class="layui-row" style="margin-top: 10px;">        <div class="layui-col-md12"style="margin-top: 20px;">            <div class="grid-demo grid-demo-bg1">                <label class="layui-form-label" style="padding-left: 15px;text-align: left;width: 80px;">选中样式：</label>                <img id="markpointselected_style" src="/Resources/img/mark/mark_P1.png" style=" width: 25px; height: 25px;margin: 5px;" class="markPointStyle">                <button type="button" class="layui-btn  layui-btn-sm" style="margin-left: 60px;" id="select_mark_style_id" onclick="getMarkStyle()">确定</button>            </div>        </div>    </div></form>'
            , zIndex: layer.zIndex
            , success: function (layero) {
                layer.setTop(layero);
            }
...
$(document).on("click", "img[class='markPointStyle']", function (event) {
    var src = event.target.src + "?t=" + Math.random();
    document.getElementById("addmarkpointinfo_style").setAttribute("src", src);
    document.getElementById("markpointselected_style").setAttribute("src", src);   
});
